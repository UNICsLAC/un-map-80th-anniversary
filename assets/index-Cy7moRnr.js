...
`;if(f){const h=_(f);h&&(i+=`
  ...
  <i class="fa-solid fa-chevron-down"></i>
        ...
        `;return}s.forEach(n=>{const o=d(n,"Country"),r=d(n,"Year"),c=A(n),a=document.createElement("div");a.className="country-item",a.innerHTML=`
        ...
        `,a.onclick=()=>H(n),t.appendChild(a)})}function H(e){const t=p.find(s=>s.countryData===e);if(t){b(),l.closePopup(),l.setView(t.getLatLng(),6),setTimeout(()=>{const o=C(e);t.setPopupContent(o),t.openPopup(),setTimeout(()=>{E()},150)},300);const s=document.getElementById("sidebar"),n=document.getElementById("sidebar-toggle");window.innerWidth<=768&&s&&s.classList.contains("active")&&(s.classList.remove("active"),n.style.opacity="1",n.style.pointerEvents="auto")}}function k(e){if(!e)return null;let t=String(e);t=t.replace(/−/g,"-"),t=t.replace(/\u2212/g,"-");const s=parseFloat(t);return isNaN(s)?null:s}function O(){document.body.insertAdjacentHTML("beforeend",`
