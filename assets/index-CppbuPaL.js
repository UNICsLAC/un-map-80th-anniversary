  ...
  <i class="fa-solid fa-chevron-down"></i>
        ...
        `;return}s.forEach(n=>{const o=d(n,"Country"),r=d(n,"Year"),c=N(n),a=document.createElement("div");a.className="country-item",a.innerHTML=`
            ...
            <div class="country-info">
                ...
                <div class="country-year">${p==="es"?"Año: ":"Year: "}${r}</div>
            </div>
        `,a.onclick=()=>U(n),t.appendChild(a)})}function U(e){const t=m.find(s=>s.countryData===e);if(t){b(),l.closePopup(),l.setView(t.getLatLng(),6),setTimeout(()=>{const o=C(e);t.setPopupContent(o),t.openPopup(),setTimeout(()=>{E()},150)},300);const s=document.getElementById("sidebar"),n=document.getElementById("sidebar-toggle");window.innerWidth<=768&&s&&s.classList.contains("active")&&(s.classList.remove("active"),n.style.opacity="1",n.style.pointerEvents="auto")}}function T(e){if(!e)return null;let t=String(e);t=t.replace(/−/g,"-"),t=t.replace(/\u2212/g,"-");const s=parseFloat(t);return isNaN(s)?null:s}function H(){document.body.insertAdjacentHTML("beforeend",`
    ...
    `);const t=document.getElementById("close-disclaimer"),s=document.getElementById("disclaimer-alert");$(),t.addEventListener("click",()=>{s.style.animation="slideDown 0.3s ease-out",setTimeout(()=>{s.remove()},300)})}function $(){const e=document.getElementById("disclaimer-text");if(!e)return;const t=p==="es";e.textContent=t?`"Los límites y nombres que aparecen en este mapa, así como las denominaciones utilizadas, no implican su reconocimiento o aceptación oficial por parte de las Naciones Unidas.
    La frontera definitiva entre la República de Sudán y la República de Sudán del Sur aún no se ha determinado.
            ...
            *** Existe una disputa entre los Gobiernos de Argentina y el Reino Unido de Gran Bretaña e Irlanda del Norte sobre la soberanía de las Islas Malvinas (Falkland).`:`"The boundaries and names shown and the designations used on this map do not imply official endorsement or acceptance by the United Nations.
            Final boundary between the Republic of Sudan and the Republic of South Sudan has not yet been determined.
            * Non-Self-Governing Territory
            ** Dotted line represents approximately the Line of Control in Jammu and Kashmir agreed upon by India and Pakistan. The final status of Jammu and Kashmir has not yet been agreed upon by the parties.
            *** A dispute exists between the Governments of Argentina and the United Kingdom of Great Britain and Northern Ireland concerning sovereignty over the Falkland Islands (Malvinas)"`}function O(e){S=e;const t=L.divIcon({className:"custom-marker",html:'<div class="marker-pin"></div>',iconSize:[20,20],iconAnchor:[10,20]}),s=L.divIcon({className:"custom-marker hover",html:'<div class="marker-pin"></div>',iconSize:[24,24],iconAnchor:[12,24]});l=L.map("map-container",{zoomControl:!1,minZoom:3,maxZoom:6,tap:!0,touchZoom:!0,doubleClickZoom:!0,scrollWheelZoom:!0}).setView([-15,-60],4),L.esri.tiledMapLayer({url:"https://geoservices.un.org/arcgis/rest/services/ClearMap_WebGray/MapServer",minZoom:3,maxZoom:6}).addTo(l),m.forEach(a=>{l.removeLayer(a)}),m=[],e.forEach((a,u)=>{const v=T(a.Latitude),f=T(a.Longitude);if(v===null||f===null)return;const i=L.marker([v,f],{icon:t,title:d(a,"Country"),riseOnHover:!1,riseOffset:0}).addTo(l);i.countryData=a,i.countryIndex=u,i.isHovered=!1;const h=C(a);i.bindPopup(h,{maxWidth:700,className:"custom-popup",closeButton:!1,autoClose:!1,closeOnClick:!1,keepInView:!1});const x=g=>{g.originalEvent.stopPropagation(),g.originalEvent.preventDefault(),l.closePopup(),b(),i.openPopup(),E()};i.on("click",x),i.on("touchend",g=>{g.originalEvent.stopPropagation(),g.originalEvent.preventDefault(),l.closePopup(),b(),i.openPopup(),E()}),i.on("mouseover",()=>{i.isHovered||(i.setIcon(s),i.isHovered=!0)}),i.on("mouseout",()=>{i.isHovered&&(i.setIcon(t),i.isHovered=!1)}),m.push(i)}),l.on("click",a=>{(a.originalEvent.target.classList.contains("leaflet-container")||a.originalEvent.target.classList.contains("leaflet-map-pane"))&&(l.closePopup(),b())}),l.on("dragend",()=>{l.dragging.enable()}),w(),document.getElementById("search-input").addEventListener("input",w);const n=document.getElementById("sidebar-toggle"),o=document.getElementById("sidebar");n.addEventListener("click",a=>{a.stopPropagation(),o.classList.contains("active")?(o.classList.remove("active"),n.style.opacity="1",n.style.pointerEvents="auto"):(o.classList.add("active"),n.style.opacity="0",n.style.pointerEvents="none")}),document.getElementById("map-container").addEventListener("click",()=>{o.classList.contains("active")&&(o.classList.remove("active"),n.style.opacity="1",n.style.pointerEvents="auto")}),document.addEventListener("click",a=>{o.classList.contains("active")&&!o.contains(a.target)&&!n.contains(a.target)&&(o.classList.remove("active"),n.style.opacity="1",n.style.pointerEvents="auto")});const c=localStorage.getItem("preferredLanguage")||A();I(c)}async function D(){try{const e=await fetch("data/countries.json");if(!e.ok)throw new Error(`Error al cargar countries.json: ${e.status}`);const t=await e.json();console.log("Loaded countries data:",t.length,"countries"),O(t),H(),console.log("Created markers:",m.length)}catch(e){document.getElementById("map-container").innerHTML=`<div class="error-message">
                <h2>❌ Error</h2>
                <p>${e.message}</p>
            </div>`}}D();function b(){const e=L.divIcon({className:"custom-marker",html:'<div class="marker-pin"></div>',iconSize:[20,20],iconAnchor:[10,20]});m.forEach(t=>{t.setIcon(e),t.isHovered=!1})}
